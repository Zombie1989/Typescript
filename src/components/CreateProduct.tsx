...
const CreateForm = () => {
  ...
  return (
    <form onSubmit={update} className="d-grid mb-5">
      ...
      <input value={product.price} onChange={(e) => setProduct({...product, price: e.target.value})} type="text" className="form-control py-2 mb-3" placeholder="Enter your password" />
