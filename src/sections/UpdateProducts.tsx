...
const UpdateProduct: React.FC = () => {
  const { product, setProduct, update } = React.useContext(ProductContext) as ProductContextType
  ...
  return (
    <div className="container">
      <form onSubmit={update} className="d-grid mb-5">
        ...
        <button type="submit" className="btn btn-red py-2 mt-3">UPDATE PRODUCT</button>
      </form>
      <form>
